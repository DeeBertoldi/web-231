...
function zeroTheRegister() {
   changeBox.value = 0;
  document.getElementById("bill20").value = 0;
   document.getElementById("bill10").value = 0;
   document.getElementById("bill5").value  = 0;
   document.getElementById("bill1").value  = 0;
   document.getElementById("coin25").value = 0;
